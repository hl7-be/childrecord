# Child Report Logical Model - Child Report v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeModelChildReport | *Version*:0.1.0 |
| Draft as of 2026-03-19 | *Computable Name*:BeModelChildReport |
...
```json
{
  ...
  "baseDefinition" : "https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeModelDocument",
