# Document model - Child Report v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeModelDocument | *Version*:1.0.0 |
| Draft as of 2026-03-20 | *Computable Name*:BeModelDocument |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.be.childreport|current/StructureDefinition/BeModelDocument)
...
```json
{
  ...
  "url" : "https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeModelDocument",
  "version" : "1.0.0",
  "name" : "BeModelDocument",
  "title" : "Document model",
  "status" : "draft",
  "date" : "2026-03-20T11:18:09+00:00",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeModelDocument",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "min" : 0,
      "max" : "*",
      "contentReference" : "https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeModelDocument#BeModelDocument.section"
    }]
  }
}
