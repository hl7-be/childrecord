...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childrecord/StructureDefinition/BeModelDocument | *Version*:0.1.0 |
| Draft as of 2025-10-14 | *Computable Name*:BeModelDocument |
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "BeModelDocument.lastUpdate",
        "path" : "BeModelDocument.lastUpdate",
