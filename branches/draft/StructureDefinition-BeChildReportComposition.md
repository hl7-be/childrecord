# Child Report Composition - Child Report v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeChildReportComposition | *Version*:0.1.0 |
| Draft as of 2026-03-19 | *Computable Name*:BeChildReportComposition |

The terminology used in this profile is indicative and will be published in a dedicated terminology package.

**Usages:**

* Use this Profile: [BeVlChildReport](StructureDefinition-BeVlChildReport.md)
