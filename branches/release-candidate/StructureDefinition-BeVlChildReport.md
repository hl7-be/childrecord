# BeVlChildReport - Child Report v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeVlChildReport | *Version*:0.1.0 |
| Draft as of 2026-03-19 | *Computable Name*:BeVlChildReport |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.be.childreport|current/StructureDefinition/BeVlChildReport)
...
Other representations of profile: [CSV](StructureDefinition-BeVlChildReport.csv), [Excel](StructureDefinition-BeVlChildReport.xlsx), [Schematron](StructureDefinition-BeVlChildReport.sch) 
...
```json
{
  ...
  "id" : "BeVlChildReport",
  "url" : "https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeVlChildReport",
  "version" : "0.1.0",
  "name" : "BeVlChildReport",
  "status" : "draft",
  "date" : "2026-03-19T20:33:31+00:00",
  ...
  "differential" : {
    ...
    {
      "id" : "Bundle.entry:careSet",
      "path" : "Bundle.entry",
      "sliceName" : "careSet"
    },
    {
      "id" : "Bundle.entry:careSet.fullUrl",
      "path" : "Bundle.entry.fullUrl",
      "min" : 1,
      "mustSupport" : true
    },
    ...
    },
    {
      ...
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "http://snomed.info/sct",
          "code" : "28944009",
          "display" : "Infection caused by Cytomegalovirus"
        }]
      }
    },
    {
