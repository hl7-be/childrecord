...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childrecord/StructureDefinition/BeModelRelatedPerson | *Version*:0.1.0 |
| Draft as of 2025-10-14 | *Computable Name*:BeModelRelatedPerson |
...
* Use this Logical Model: [Child Report Logical Model](StructureDefinition-BeModelChildReport.md)
