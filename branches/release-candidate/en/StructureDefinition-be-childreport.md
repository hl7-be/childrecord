# BeChildReport - Child Report v1.0.2
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.be.childreport|current/StructureDefinition/StructureDefinition-be-childreport.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "comment" : "Must contain the Composition as the first entry (only a single Composition resource instance may be included) and may include a Patient resource.",
      "min" : 2,
    ...
    },
    {
      ...
      "path" : "Bundle.entry",
      "sliceName" : "patient",
      "short" : "The child (patient) - this is an optional entry - in cases where a patient is identified with a logical reference",
      "min" : 0,
      "max" : "1",
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Patient",
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-patient|2.2.0"]
      }]
    },
    {
    ...
    {
      "id" : "Bundle.entry:presentedForm",
      "path" : "Bundle.entry",
      "sliceName" : "presentedForm",
      "short" : "PDF rendition of the child report (inline data or remote URL)",
      "min" : 1,
      "max" : "1",
      "mustSupport" : true
    },
    {
      "id" : "Bundle.entry:presentedForm.resource",
      "path" : "Bundle.entry.resource",
      "short" : "DocumentReference pointing to the PDF rendition",
      "type" : [{
        "code" : "DocumentReference",
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-documentreference|2.2.0"]
      }]
    },
    {
      "id" : "Bundle.entry:presentedForm.resource.status",
      "path" : "Bundle.entry.resource.status",
      "patternCode" : "current"
    },
    {
      "id" : "Bundle.entry:presentedForm.resource.content",
      "path" : "Bundle.entry.resource.content",
      "max" : "1"
    },
    {
      "id" : "Bundle.entry:presentedForm.resource.content.attachment.contentType",
      "path" : "Bundle.entry.resource.content.attachment.contentType",
      "short" : "application/pdf",
      "patternCode" : "application/pdf"
    },
    {
      "id" : "Bundle.entry:presentedForm.resource.content.attachment.data",
      "path" : "Bundle.entry.resource.content.attachment.data",
      "short" : "Inline (base64) PDF content - use for embedded delivery"
    },
    {
      "id" : "Bundle.entry:presentedForm.resource.content.attachment.url",
      "path" : "Bundle.entry.resource.content.attachment.url",
      "short" : "Link to the PDF - use for remote delivery"
    }]
  }
}
