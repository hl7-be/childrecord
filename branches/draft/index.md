...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childreport/ImplementationGuide/hl7.fhir.be.childreport | *Version*:0.1.0 |
| Draft as of 2025-02-26 | *Computable Name*:ChildReport |
...
```json
{
  ...
  "definition" : {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/BeVlChildReport"
      },
