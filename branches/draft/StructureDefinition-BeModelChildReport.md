...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childrecord/StructureDefinition/BeModelChildReport | *Version*:0.1.0 |
| Draft as of 2025-10-14 | *Computable Name*:BeModelChildReport |
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "BeModelChildReport.lastUpdate",
        "path" : "BeModelChildReport.lastUpdate",
      ...
      {
        "id" : "BeModelChildReport.relatedPerson",
        "path" : "BeModelChildReport.relatedPerson",
        "short" : "Biological mother of the child that the report is about",
        "definition" : "The biological mother of the child is the related subject in this report.",
        "min" : 0,
        "max" : "1",
        "type" : [
          {
      ...
      {
        "id" : "BeModelChildReport.relatedPerson.relationship",
        "path" : "BeModelChildReport.relatedPerson.relationship",
      ...
      {
        "id" : "BeModelChildReport.pregnancyDetails.durationOfPregnancy.focus",
        "path" : "BeModelChildReport.pregnancyDetails.durationOfPregnancy.focus",
        "short" : "Mother",
        "definition" : "subject",
        "min" : 0,
        "max" : "1",
      ...
      {
        "id" : "BeModelChildReport.pregnancyDetails.pregnancyCMVInfection.focus",
        "path" : "BeModelChildReport.pregnancyDetails.pregnancyCMVInfection.focus",
        "short" : "Mother",
        "definition" : "subject",
        "min" : 0,
        "max" : "1",
      ...
      {
        "id" : "BeModelChildReport.bacterialMeningitis.focus",
        "path" : "BeModelChildReport.bacterialMeningitis.focus",
        "short" : "Mother",
        "definition" : "subject",
        "min" : 1,
        "max" : "1",
      ...
      {
        "id" : "BeModelChildReport.neonatalHearingScreening",
        "path" : "BeModelChildReport.neonatalHearingScreening",
      ...
      {
        "id" : "BeModelChildReport.neonatalHearingScreening.code",
        "path" : "BeModelChildReport.neonatalHearingScreening.code",
        "short" : "Code",
        "definition" : "Code",
        "min" : 1,
        "max" : "1",
      ...
      {
        "id" : "BeModelChildReport.neonatalHearingScreening.date",
        "path" : "BeModelChildReport.neonatalHearingScreening.date",
      ...
      {
        "id" : "BeModelChildReport.neonatalHearingScreening.subject",
        "path" : "BeModelChildReport.neonatalHearingScreening.subject",
        "short" : "Child that the report is about",
      ...
      {
        "id" : "BeModelChildReport.neonatalHearingScreening.componentLeft",
        "path" : "BeModelChildReport.neonatalHearingScreening.componentLeft",
      ...
      {
        "id" : "BeModelChildReport.neonatalHearingScreening.componentLeft.code",
        "path" : "BeModelChildReport.neonatalHearingScreening.componentLeft.code",
      ...
      {
        "id" : "BeModelChildReport.neonatalHearingScreening.componentLeft.valueCode",
        "path" : "BeModelChildReport.neonatalHearingScreening.componentLeft.valueCode",
      ...
      {
        "id" : "BeModelChildReport.neonatalHearingScreening.componentRight",
        "path" : "BeModelChildReport.neonatalHearingScreening.componentRight",
      ...
      {
        "id" : "BeModelChildReport.neonatalHearingScreening.componentRight.code",
        "path" : "BeModelChildReport.neonatalHearingScreening.componentRight.code",
      ...
      {
        "id" : "BeModelChildReport.neonatalHearingScreening.componentRight.valueCode",
        "path" : "BeModelChildReport.neonatalHearingScreening.componentRight.valueCode",
      ...
      },
      {
        ...
        "short" : "[BeObservation] Inspection pupil abnormal",
